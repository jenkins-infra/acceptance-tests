...
sequentialStages['Spot and OnDemand'] = [ 'maven-21-windows && spot', 'maven-21-windows && nonspot', 'docker && spot', 'docker && nonspot', 'docker-highmem-nonspot'] // Pipeline Library (mostly), but also Docker-*agent and Jenkins ATH
