...
categorizedLabels['Docker Platforms'] = [ 's390xdocker', 'docker', 'arm64docker', 'windows-2022', 'windows-2025']
categorizedLabels['Spot and OnDemand'] = [ 'docker && spot', 'docker && nonspot', 'docker-highmem && spot', 'docker-highmem && nonspot'] // Pipeline Library (mostly), but also Docker-*agent and Jenkins ATH
